...
func (im IBCModule) OnRecvPacket(
	...
	return channeltypes.NewErrorAcknowledgement(sdkerrors.Wrapf(sdkerrors.ErrUnknownRequest, "cannot receive packet via interchain accounts authentication module"))
}
